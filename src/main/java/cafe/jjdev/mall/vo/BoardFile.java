...
public class BoardFile {
	...
	public int getBoardFileDelete() {
		return boardFileDelete;
	}
	public void setBoardFileDelete(int boardFileDelete) {
		this.boardFileDelete = boardFileDelete;
	}
	@Override
	public String toString() {
		return "BoardFile [boardFileNo=" + boardFileNo + ", boardNo=" + boardNo + ", boardFileOriginName="
				...
				+ ", boardFileSize=" + boardFileSize + ", boardFileType=" + boardFileType + ", boardFileDelete="
				+ boardFileDelete + "]";
	}
